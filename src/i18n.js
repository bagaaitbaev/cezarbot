...
export const T = {
  ru: {
    ...
    cancel_confirm_q: 'Отменить бронь?',
    btn_yes: 'Да',
    btn_no: 'Нет',
    cancel_done: '✅ Бронь отменена.',
    cancel_not_found: '❌ Бронь не найдена.',
    cancel_not_allowed: '❌ Нельзя отменить эту бронь.',
  ...
  kz: {
    ...
    cancel_confirm_q: 'Броньды болдырмайсыз ба?',
    btn_yes: 'Иә',
    btn_no: 'Жоқ',
    cancel_done: '✅ Бронь болдырылды.',
    cancel_not_found: '❌ Бронь табылмады.',
    cancel_not_allowed: '❌ Бұл броньды болдырмауға болмайды.',
